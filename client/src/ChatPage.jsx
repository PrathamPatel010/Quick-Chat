    ...
    return(
        <>
            <div className={'flex h-screen'}>
                <div className={'bg-blue-100 w-1/4 p-2'}>
                    <h1 className={'flex gap-2 mb-2 p-2 text-blue-600 font-bold'}>
                    ...
                    </h1>
                    {
                        Object.keys(onlinePeople).map((userId)=> {
                            return(
                            <div key={userId} className={'flex items-center cursor-pointer gap-2 border-2 border-gray-300 py-2'}>
